...
// Active nav link
const navLinks = document.querySelectorAll('.nav-link-custom[data-page]');
...
/* ─────────────────────────────────────────────
   15. HERO SEARCH STRIP TABS
───────────────────────────────────────────── */
document.querySelectorAll('.sst-tab').forEach(tab => {
  tab.addEventListener('click', () => {
    document.querySelectorAll('.sst-tab').forEach(t => t.classList.remove('active'));
